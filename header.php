      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse nav-pills" id="navbarCollapse">
          ...
          <nav class="sb-topnav navbar navbar-expand navbar-dark">
            ...
            <li class="nav-item">
                <a href="wishlist.php" class="nav-link text-white h5">
                  <i class="icon fa fa-heart"></i>
                  Wishlist
                </a>
            </li>
            <li class="nav-item">
                <a href="shipping/shipping.php" class="nav-link text-white fw-bold">
                  <button type="button" class="btn btn-info btn-sm fw-bold">Track Order</button>
                </a>
            </li>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="topnav search-container">
        <form class="d-flex" action="">
          <input type="search" class="form-control me-2" name="search" placeholder="Products ..." aria-label="Search">
